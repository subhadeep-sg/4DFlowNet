...
def upsample3d(input_tensor, res_increase):
    ...
    resize_b_x = tf.image.resize(squeeze_b_x, [y_size_new, z_size_new], method='bilinear')
    ...
    resize_b_z = tf.image.resize(squeeze_b_z, [y_size_new, x_size_new], method='bilinear')
